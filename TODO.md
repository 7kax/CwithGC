...
| --- | --- | --- | --- | --- | --- |
| [ ] | 3 | P1 | compiler / integration | Implement a minimal automatic instrumentation pipeline | C inputs containing no hand-written GC calls are lowered, compiled, linked, and executed against all three collectors; lowering enforces the v1 alignment and pointer-representation limits, sequences field-slot formation after safe points, and fixtures cover scalars, structs, fixed arrays, calls, recursion, and multiple returns |
